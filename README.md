...
[![Downloads](https://img.shields.io/github/downloads/aimms/employee-scheduling/total?style=for-the-badge&logo=github&labelColor=000081&color=1847c9)](https://github.com/aimms/employee-scheduling/releases)
...
1. **Download the Release:** Go to the [Releases](https://github.com/aimms/employee-scheduling/releases) page and download the `.zip` file from the latest version.
...
- Found an issue? [Open an issue](https://github.com/aimms/employee-scheduling/issues).
